  ...
  return (
    <>
      <div className="relative h-screen w-full animate__animated animate__fadeIn animate__delay-2s">
        ...
        <div className={`absolute inset-0 bg-${isDark ? "black" : "white"} bg-opacity-50 flex flex-col items-center justify-center text-center px-4 transition-colors duration-500`}>
